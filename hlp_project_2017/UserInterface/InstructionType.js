define(["exports", "fable-core/umd/Symbol", "fable-core/umd/Util", "fable-core/umd/List"], function (exports, _Symbol2, _Util, _List) {
    ...
    exports.Memory = exports.InstructionLine = exports.InstructionType = exports.ConditionCode = exports.BRANCHInst = exports.LABELInst = exports.SHIFTInst = exports.MEMInst = exports.LDMdir = exports.SFInst = exports.ALUInst = exports.RegOrLit = exports.Address = exports.Register = undefined;
        ...
        [_Symbol3.default.reflection]() {
            return {
                ...
                cases: {
                    ...
                    AND: [Register, Register, RegOrLit],
    ...
    class LABELInst {
        ...
        [_Symbol3.default.reflection]() {
            return {
                type: "ARM7TDMI.InstructionType.LABELInst",
                interfaces: ["FSharpUnion", "System.IEquatable", "System.IComparable"],
                cases: {
                    DCD: [Address, (0, _Util.makeGeneric)(_List2.default, {
                        T: "number"
                    })],
                    EQU: [Address, "number"],
                    FILL: [Address, "number"]
    ...
    exports.LABELInst = LABELInst;
    (0, _Symbol2.setType)("ARM7TDMI.InstructionType.LABELInst", LABELInst);
