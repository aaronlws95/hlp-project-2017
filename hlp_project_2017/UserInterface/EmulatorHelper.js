define(["exports", "fable-core/umd/Symbol", "fable-core/umd/Util", "./MachineState", "fable-core/umd/Long", "fable-core/umd/Map", "fable-core/umd/String"], function (exports, _Symbol2, _Util, _MachineState, _Long, _Map, _String) {
    "use strict";
    ...
    const ProcessFlag = exports.ProcessFlag = function (__exports) {
        ...
        const processFlags = __exports.processFlags = function (state, instruction) {
            ...
            if (instruction.Case === "SUB") {
                ...
                return new _MachineState.Flags(N(instruction.Fields[2]), Z(instruction.Fields[2]), (((instruction.Fields[0] & -2147483648 >> instruction.Fields[1] - 1) === instruction.Fields[0] ? instruction.Fields[0] !== 0 ? instruction.Fields[1] !== 0 : false : false) ? instruction.Fields[1] < 31 : false) ? true : instruction.Fields[1] === 0 ? state.Flags.C : false, state.Flags.V);
            } else if (instruction.Case === "LSR") {
                return new _MachineState.Flags(N(instruction.Fields[2]), Z(instruction.Fields[2]), (((instruction.Fields[0] & 1 << instruction.Fields[1] - 1) === 1 << instruction.Fields[1] - 1 ? instruction.Fields[0] !== 0 ? instruction.Fields[1] !== 0 : false : false) ? instruction.Fields[1] < 31 : false) ? true : instruction.Fields[1] === 0 ? state.Flags.C : false, state.Flags.V);
            } else if (instruction.Case === "ASR") {
                return new _MachineState.Flags(N(instruction.Fields[2]), Z(instruction.Fields[2]), ((((instruction.Fields[0] & 1 << instruction.Fields[1] - 1) === 1 << instruction.Fields[1] - 1 ? instruction.Fields[0] !== 0 ? instruction.Fields[1] !== 0 : false : false) ? instruction.Fields[1] < 31 : false) ? true : instruction.Fields[1] > 31 ? instruction.Fields[0] < 0 : false) ? true : instruction.Fields[1] === 0 ? state.Flags.C : false, state.Flags.V);
            } else if (instruction.Case === "ROR") {
                return new _MachineState.Flags(N(instruction.Fields[2]), Z(instruction.Fields[2]), ((instruction.Fields[0] & 1 << instruction.Fields[1] % 32 - 1) === 1 << instruction.Fields[1] % 32 - 1 ? instruction.Fields[0] !== 0 ? instruction.Fields[1] !== 0 : false : false) ? true : instruction.Fields[1] === 0 ? state.Flags.C : false, state.Flags.V);
    ...
    const Extractor = exports.Extractor = function (__exports) {
        ...
        const isValidAddress = __exports.isValidAddress = function (state, addr) {
            const matchValue = (0, _Map.tryFind)(addr, state.MemMap);

            if (matchValue == null) {
                return false;
            } else if (matchValue.Case === "Inst") {
                return false;
            } else {
                return true;
            }
