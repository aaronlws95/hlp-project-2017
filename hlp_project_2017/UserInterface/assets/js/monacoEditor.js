...
requirejs(['vs/editor/editor.main'], function () {
    ...
    monaco.languages.setMonarchTokensProvider('ARM', {
        ...
        tokenizer: {
            root: [
                ...
                [/\b(MOV|ADD|SUB|MVN|EOR|RSB|RSC|ADC|SBC|BIC|ORR|AND|ADR)(S)?(EQ|NE|CS|HS|CC|LO|MI|PL|VS|VC|HI|LS|GE|LT|GT|LE|AL)?\b/, "arithmetic"],
    ...
    monaco.editor.defineTheme('ARMTheme', {
        ...
        rules: [
            ...
            { token: 'others', foreground: '536DFE', fontStyle: 'bold' },
